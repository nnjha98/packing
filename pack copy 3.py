...
class Level:
    ...
    def retstruct(self):
        ...
        for b in self.boxesInLevel:
            temp = {}
            temp['pos']=[b.boxx + b.box.w/2,self.levelHeight+b.box.h/2,b.boxy+b.box.d/2]
            temp['size']=[b.box.w,b.box.h,b.box.d]
            ret.append(temp)
        return ret
    ...
    if request.method == 'POST':
        ...
        for c in allBigBoxes:
            ...
            if (val):
                ...
                placement = []
                for l in levelArray:
                    placement = placement + l.retstruct()
                utilizationArray.append([containerEffeciency, totalVolOfBoxes/c.vol, placement])
